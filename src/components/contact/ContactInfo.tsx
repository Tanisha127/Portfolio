  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "tanishasuhag127@gmail.com",
      link: "mailto:tanishasuhag127@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5 text-brand-purple" />,
      title: "Location",
      details: "Delhi , India",
      link: "https://maps.google.com/?q=Delhi",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/Tanisha127",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      name: "LinkedIn",
      url: "www.linkedin.com/in/tanishasuhag",
    }
  ];
